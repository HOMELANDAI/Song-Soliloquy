...
Version: 2.2 - includes workflow audit, optional entertainment-value layers, Did You Know / Context Cards, production-performance notes, verification fields, updated schema addendum, and Supabase backend integration patch.
