...
# Addendum v3.1 — Metaphor + Entendre Detection Layer

This addendum adds a structured figurative-language system to Song Soliloquy.

## Why This Addendum Exists

The project already supports general bar analysis and technical notes, but the website needs a first-class structure for:

- Metaphor detection and explanation.
- Double entendre detection.
- Triple entendre detection.
- Separate breakdowns for each entendre layer.
- Confidence labels.
- Bar Explorer filters.
- NotebookLM export indexing.
- YouTube and OBS-friendly wordplay moments.

## Rule

Do not force metaphors or entendres. If a bar does not contain a meaningful metaphor or layered meaning, leave the figurative language field empty.

## Schema Add-On

Every `bar_analysis` object may include:
...
Each item in `figurative_devices` should include:

```json
{
  "device_type": "metaphor | double_entendre | triple_entendre | pun | symbolism | idiom_flip",
  "phrase": "",
  "short_explanation": "",
  "confidence": "possible | strong | confirmed",
  "metaphor": {
    "subject": "",
    "image_or_vehicle": "",
    "shared_meaning": "",
...
Add a collapsible `FIGURATIVE LANGUAGE` panel inside Bar Analysis cards.

The panel should support:

- Metaphor Card
- Double Entendre Card
- Triple Entendre Card
- Confidence badges
- YouTube value
- Add to Script
- Add to OBS Overlay
...
NotebookLM exports should include a `Figurative Language Index` section.

YouTube-ready angle should include `Best Wordplay / Entendre Moment`.

## OBS Add-On

Add optional stream-readable overlays for:

- Metaphor card
- Double entendre card
- Triple entendre card
- Best wordplay moment

## Acceptance Criteria

1. Existing uploads without figurative-language fields still render.
2. Metaphors show subject, vehicle, shared meaning, emotional function, and why it works.
3. Double entendres show Layer 1 and Layer 2.
4. Triple entendres show Layer 1, Layer 2, and Layer 3.
5. Triple entendre is only used when all three meanings are plausible.
6. Bar Explorer can filter by device type.
7. NotebookLM and YouTube exports can include figurative language.
8. OBS overlays can show short wordplay cards.
9. The approved layout, theme toggle, upload flow, Song Detail route, Supabase path, and OBS connection remain unchanged.
